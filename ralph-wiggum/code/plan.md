...
| [x] | **Task 6.1**: Delete legacy `/dashboard` routes | `specs/phase3-plan.md:L156-163` | Done in v0.3.0-task6.1 |
| [x] | **Task 6.2**: Update `nav-config.ts` to remove static items | `specs/phase3-plan.md:L160` | Done in v0.3.0-task6.2 - Removed static Kanban item, navItems now empty (projects are dynamic) |
